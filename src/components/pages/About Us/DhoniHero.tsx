...
.dh-hero-inner{position:relative;z-index:2;max-width:1100px;width:100%;margin:0 auto;padding:0 clamp(1.15rem,4vw,3rem) clamp(2.4rem,6vh,4.5rem);}
...
.dh-content-in{max-width:760px;margin:0 auto;padding:0 clamp(1.15rem,4vw,2.6rem);}
...
.dh-p{font-size:clamp(1rem,1.1vw,1.05rem);line-height:1.85;color:#111;margin:0 0 1.3rem;}
