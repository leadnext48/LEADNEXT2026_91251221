  ...
  return (
    <section className="min-h-screen w-full px-6 lg:px-20">
      ...
      <div className="mx-auto w-full max-w-[1400px]">
        <div className={`cbs-grid ${playfair.className} min-h-screen`}>
          ...
          {/* BOOK — sits on the right on desktop; on mobile it appears ABOVE the
              testimonials (grid areas) so two photos don't stack back-to-back. */}
          <div className="cbs-book flex justify-center items-center">
          ...
          <motion.div
            className="cbs-testimonial relative px-3 py-2 rounded-md bg-white/80 backdrop-blur-sm shadow-sm w-full max-w-md"
          ...
          <style>{`
            .cbs-grid { display:flex; flex-direction:column; gap:2rem; }
            .cbs-intro { grid-area:intro; }
            .cbs-book { grid-area:book; }
            .cbs-testimonial { grid-area:testi; }
            @media (min-width:1024px) {
              .cbs-grid {
                display:grid;
                grid-template-columns:57% 43%;
                grid-template-areas:"intro book" "testi book";
