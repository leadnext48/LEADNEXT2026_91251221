      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        <div className="relative order-1 md:order-2 flex justify-center items-center h-full">
            <motion.div
                ...
                className="absolute z-0 h-[300px] w-[300px] rounded-full bg-yellow-400/90 md:h-[400px] md:w-[400px] lg:h-[400px] lg:w-[400px]"
            ></motion.div>
            <motion.img
                src={imageSrc}
                alt={imageAlt}
        ...
        >
          <h1 className="text-7xl text-left font-extrabold text-foreground md:text-8xl lg:text-6xl">
            {overlayText.part1}
            <br />
            {overlayText.part2}
          </h1>
