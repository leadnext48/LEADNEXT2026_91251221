      ...
      <div className="overflow-x-hidden">
            ...
            <div className="ref-steps">
              {STEPS.map((s) => (
                <div key={s.title} className="ref-step">
                  ...
                  <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(0.76rem, 0.9vw, 0.86rem)', lineHeight: 1.7, color: '#666', margin: 0 }}>{s.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section ref={bodyRef} className="ref-form-section">
          <div className="ref-form-hdr" style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(0.8rem, 0.95vw, 0.9rem)', color: '#777', margin: '0.8rem auto 0', maxWidth: 480, lineHeight: 1.7 }}>
