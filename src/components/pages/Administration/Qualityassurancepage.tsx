        ...
        <section ref={heroRef} className="qa-hero">
          ...
          <div className="qa-hero-inner">
            ...
            <div className="qa-hero-sub">
              ...
              <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 1.05vw, 1rem)', lineHeight: 1.85, color: '#111', margin: 0 }}>
          ...
          <div className="qa-accred-strip">
            {accredBodies.map((b) => (
              <div key={b.label} className="qa-accred-row">
                ...
                <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(0.7rem, 0.85vw, 0.8rem)', color: '#111', margin: 0, lineHeight: 1.35 }}>{b.sub}</p>
              </div>
            ))}
          </div>
        ...
        <section ref={overviewRef} className="qa-accred-overview">
          ...
          <div className="qa-accred-overview-inner">
            <div className="qa-aov-text" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', lineHeight: 1.85, color: '#111', margin: '0 0 clamp(1rem, 2vh, 1.6rem)', maxWidth: 460 }}>
              ...
              <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', lineHeight: 1.82, color: '#111', margin: 0, maxWidth: 460 }}>
            ...
            {personas.map((p) => (
              <div key={p.id} className="qa-persona-card">
                ...
                <div className="qa-persona-body">
                  ...
                  <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', lineHeight: 1.82, color: '#111', margin: 0 }}>{p.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="qa-link-band-content">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1.5rem' }}>
              <div>
                ...
                <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', color: '#fff', margin: 'clamp(0.5rem, 1vh, 0.8rem) 0 0', lineHeight: 1.6 }}>
        ...
        <section ref={discRef} className="qa-disclosures-section">
          <div className="qa-disc-hdr">
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
              ...
              <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', color: '#111', margin: 0, maxWidth: 400, lineHeight: 1.7 }}>
          ...
          <div className="qa-fi-inner">
            ...
            <div className="qa-fi-body">
              <div className="qa-fi-intro-text">
                ...
                <div style={{ width: 36, height: 2, background: BLUE, marginBottom: 'clamp(1rem, 2vh, 1.6rem)', borderRadius: 1 }} />
                <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', lineHeight: 1.85, color: '#111', margin: '0 0 clamp(0.8rem, 1.5vh, 1.1rem)' }}>
                ...
                <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', lineHeight: 1.82, color: '#111', margin: '0 0 clamp(0.8rem, 1.5vh, 1.1rem)' }}>
                ...
                <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.95vw, 1rem)', lineHeight: 1.82, color: '#111', margin: 0 }}>
                ...
                {INNOVATIONS.map((item) => (
                  <div key={item.title} className="qa-fi-card">
                    ...
                    <div>
                      ...
                      <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.9vw, 1rem)', lineHeight: 1.72, color: '#111', margin: 0 }}>{item.body}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="qa-fi-cta">
              <div>
                ...
                <p style={{ fontFamily: playfair.style.fontFamily, fontSize: 'clamp(1rem, 0.98vw, 1rem)', lineHeight: 1.6, color: '#111', margin: 0, maxWidth: 560 }}>
