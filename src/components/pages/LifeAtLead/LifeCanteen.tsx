...
import {
  UtensilsCrossed, Leaf, Users, Heart,
  Star, Sprout, ShieldCheck, Coffee,
  type LucideIcon,
} from "lucide-react";
...
const TYPE = {
  eyebrow: {
    fontSize:      "clamp(.68rem,.8vw,.74rem)" as string,
    letterSpacing: ".2em",
...
/* ─── DATA ─── */
const COLLAB_POINTS = [
  "Enjoy hygienic, freshly prepared meals served throughout the day",
  "Savour a menu that blends local flavours with diverse cuisines",
  "Benefit from ingredients sourced directly from LEAD's own farm",
  "Dine in a welcoming space designed for community and conversation",
  "Eat nutritiously with meals planned to support health and well-being",
  "Experience a canteen culture that reflects LEAD's commitment to wellness",
];
...
function HeroSection(): React.JSX.Element {
  const STRIP_ITEMS = [
    { icon: UtensilsCrossed, label: "Hygienic & Fresh",    sub: "Prepared daily with care" },
    { icon: Leaf,            label: "Farm to Table",       sub: "Sourced from LEAD's farm" },
    { icon: Users,           label: "Vibrant Social Hub",  sub: "Where ideas meet over meals" },
  ];
  ...
  return (
    <>
      <style>{`
        ...
        .canteen-strip-item:last-child  { border-right: none; }
        .canteen-strip-text { min-width: 0; overflow: hidden; }
        .canteen-strip-label {
          display: block;
      ...
      <section className="canteen-hero">
        <div className="canteen-hero-bg-text" aria-hidden="true">CANTEEN</div>

        <div className="canteen-hero-inner">
          {/* LEFT */}
          <div style={{ minWidth: 0 }}>
            ...
            <motion.h1
              ...
              <span style={{ display: "block", color: "#0D0D0D" }}>Good Food</span>
            ...
            <motion.div
              className="canteen-hero-strip"
              initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
              transition={{ duration: .55, delay: .42, ease: "easeOut" }}>
              {STRIP_ITEMS.map(s => {
                const Icon = s.icon;
                return (
                  <div key={s.label} className="canteen-strip-item">
                    <div style={{
                    ...
                    <div className="canteen-strip-text">
                      <strong className="canteen-strip-label" style={{ fontFamily: cinzel.style.fontFamily }}>{s.label}</strong>
                      <span className="canteen-strip-sub" style={{ fontFamily: playfair.style.fontFamily }}>{s.sub}</span>
                    </div>
                  </div>
                );
              })}
          ...
          {/* RIGHT — hero photo */}
          <div className="canteen-hero-right">
            <motion.div
...
function PosterSection(): React.JSX.Element {
  ...
  const tags = [
    "Hygienic Kitchen", "Balanced Meals", "Local Cuisine",
    "Diverse Menu", "Farm-Fresh Ingredients", "Vibrant Dining Space",
  ];
        ...
        <div style={{
          ...
          <motion.div
            ...
            <div style={{ position: "relative", height: "clamp(320px,38vw,480px)" }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: cinzel.style.fontFamily, fontSize: "clamp(.66rem,.8vw,.72rem)", letterSpacing: ".1em", textTransform: "uppercase", color: "rgba(255,255,255,.75)", fontWeight: 600 }}>Fresh & Nutritious Daily</span>
                </div>
              </div>
            ...
            <div style={{
              ...
              <p style={{ fontFamily: cinzel.style.fontFamily, ...TYPE.eyebrow, color: C.green, marginBottom: ".75rem" }}>What the Canteen Offers…</p>
          ...
          <motion.div
            ...
            <p style={{ fontFamily: cinzel.style.fontFamily, ...TYPE.eyebrow, color: C.green, marginBottom: ".6rem" }}>What Makes Our Canteen Unique</p>
            <h2 style={{
              fontFamily: cinzel.style.fontFamily,
            ...
            <div style={{ borderLeft: `3px solid ${C.green}55`, paddingLeft: "1.2rem", marginBottom: "1.6rem" }}>
              <p style={{
                ...
                "Our canteen is built on the belief that good nutrition and good company go hand in hand — both are essential to a student's growth."
              </p>
            ...
            <p style={{ fontFamily: playfair.style.fontFamily, fontSize: "clamp(.92rem,.92vw,1rem)", lineHeight: 1.82, color: C.muted, margin: "0 0 1.4rem" }}>
              The LEAD canteen prioritises freshness and variety in equal measure. With a menu
              spanning local favourites and diverse cuisines, and ingredients drawn directly
              from the institution's own farm, every meal is both a nutritious choice and a
              sustainable one.
            </p>

            <div style={{ display: "flex", flexDirection: "column", gap: ".7rem" }}>
              {[
                { t: "Balanced meals prepared fresh daily in a hygienic kitchen" },
                { t: "A diverse menu rooted in local cuisine with wider variety" },
                { t: "Farm-fresh ingredients sourced from LEAD's own campus farm" },
              ].map((p, i) => (
                <div key={i} style={{
                  ...
                  <span style={{ fontFamily: playfair.style.fontFamily, fontSize: "clamp(.9rem,.88vw,1rem)", color: C.muted, lineHeight: 1.4 }}>{p.t}</span>
                </div>
              ))}
            </div>
          </motion.div>
...
function HighlightsSection(): React.JSX.Element {
  ...
  const cards = [
    { icon: ShieldCheck,     label: "Hygienic Standards",   desc: "The canteen operates with strict hygiene protocols — clean kitchens, safe food handling, and quality checks at every step of preparation",      dark: true  },
    { icon: UtensilsCrossed, label: "Nutritious Meals",     desc: "Every dish is planned to support student health, offering balanced portions of proteins, carbohydrates, and fresh vegetables daily",             dark: false },
    { icon: Leaf,            label: "Local & Diverse Menu", desc: "The menu celebrates regional cuisine while embracing variety — familiar flavours alongside dishes that reflect a broader culinary palette",       dark: false },
    { icon: Sprout,          label: "Farm to Table",        desc: "Many ingredients are sourced directly from LEAD's own farm, ensuring freshness, traceability, and a commitment to sustainable food practices",    dark: true  },
    { icon: Users,           label: "Social Dining Space",  desc: "The canteen doubles as a vibrant hub — a space where students gather between classes, exchange ideas, and build the bonds of campus community",   dark: false },
    { icon: Heart,           label: "Wellness First",       desc: "Rooted in LEAD's culture of holistic well-being, the canteen experience is designed to nourish both body and spirit throughout the academic day", dark: false },
  ];
    ...
    <section style={{
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", width: "100%", padding: `0 ${SPACE.sectionX}`, boxSizing: "border-box" }}>
        ...
        <motion.h2
          ...
          Six Reasons<br />Every Meal Matters at LEAD
        </motion.h2>
        ...
        <motion.p
          ...
          At LEAD, well-being is not an afterthought — it is woven into the rhythm of daily
          campus life. The canteen is central to that vision: a place where students eat well,
          rest briefly, and leave ready to engage with the world. From the kitchen to the table,
          every detail is considered with care.
        </motion.p>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: `0 ${SPACE.sectionX}`, position: "relative", zIndex: 2, width: "100%" }}>
        <div style={{
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={VP} variants={FADE_UP} custom={0}>
            <p style={{ fontFamily: cinzel.style.fontFamily, ...TYPE.eyebrow, color: C.green, marginBottom: ".6rem" }}>Dining & Community</p>
            <h2 style={{
              fontFamily: cinzel.style.fontFamily,
            ...
            <p style={{
              ...
              Some of the most meaningful student conversations happen not in classrooms,
              but over shared meals. The LEAD canteen is designed to be exactly that kind
              of space — open, welcoming, and full of the energy that comes from a
            ...
            <div style={{ marginTop: "1.2rem", display: "flex", alignItems: "center", gap: "1rem" }}>
              ...
              <p style={{ fontFamily: cinzel.style.fontFamily, fontSize: "clamp(.66rem,.8vw,.72rem)", letterSpacing: ".14em", textTransform: "uppercase", color: C.faint, margin: 0, lineHeight: 1.5 }}>
                Ways the canteen<br />nourishes student<br />life every day
              </p>
            </div>
          </motion.div>
...
function CommunitySection(): React.JSX.Element {
  const isMobile = useIsMobile();
  const pillars = [
    { icon: Sprout,          title: "Freshness & Sustainability", desc: "With ingredients sourced from LEAD's own farm, the canteen champions fresh, traceable food that reduces waste and supports sustainable campus living." },
    { icon: UtensilsCrossed, title: "Variety & Balance",          desc: "A thoughtfully curated menu blends local culinary traditions with broader variety, ensuring every student finds something nourishing and familiar." },
    { icon: Users,           title: "A Space to Connect",         desc: "Beyond the meal, the canteen is a social anchor of campus life — where students pause, breathe, and build the informal bonds that enrich their time at LEAD." },
  ];
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: `0 ${SPACE.sectionX}`, width: "100%" }}>
        ...
        <motion.div
          ...
          <h2 style={{
            ...
            Walk into our canteen and find more than a meal — find the warmth of a
            community, the comfort of good food, and the quiet energy that carries
        ...
        <motion.div
          ...
          <div style={{
            ...
            <div style={{ position: "absolute", left: "clamp(1.5rem,4vw,4rem)", top: "50%", transform: "translateY(-50%)" }}>
              ...
              }}>Where Every Meal<br />Tells a Story</p>
            </div>
          </div>
        </motion.div>
          ...
          {pillars.map((p, i) => {
            ...
            return (
              <motion.div key={i} variants={STAGGER_ITEM} style={{
                ...
                <h3 style={{
                  fontFamily: cinzel.style.fontFamily,
                  fontSize: "clamp(.68rem,.8vw,.74rem)",
                  fontWeight: 700,
                  textTransform: "uppercase",
                  letterSpacing: ".1em",
                  color: C.text,
        ...
        <motion.div
          ...
          <p style={{
            ...
            Nourishing students, one meal at a time — because wellness
            and community begin at the table.
          </p>
          <div style={{ flex: 1, height: 1, background: "rgba(0,92,159,.1)" }} />
        </motion.div>
...
/* ─── EXPORT ─── */
export default function Canteen(): React.JSX.Element {
  return (
    <>
      <HeroSection />
      <PosterSection />
