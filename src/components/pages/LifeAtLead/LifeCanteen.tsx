            ...
            <div style={{ position: "relative", height: "clamp(320px,38vw,480px)" }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: cinzel.style.fontFamily, fontSize: "clamp(.4rem,.52vw,.48rem)", letterSpacing: ".16em", textTransform: "uppercase", color: "rgba(255,255,255,.75)", fontWeight: 600 }}>Fresh & Nutritious Daily</span>
                </div>
              </div>
