    ...
    <>
      <style>{`
        ...
        @media(max-width:767px){
          ...
          .hostel-hero-strip { grid-template-columns: repeat(3,1fr); gap: .25rem; }
          .hostel-strip-item { padding: 0 .4rem; gap: 6px; flex-direction: column; align-items: flex-start; }
          .hostel-strip-item:first-child { padding-left: 0; }
        }
            ...
            <div style={{ position: "relative", height: "clamp(320px,38vw,480px)" }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: cinzel.style.fontFamily, fontSize: "clamp(.4rem,.52vw,.48rem)", letterSpacing: ".16em", textTransform: "uppercase", color: "rgba(255,255,255,.75)", fontWeight: 600 }}>Comfortable Living Spaces</span>
                </div>
              </div>
