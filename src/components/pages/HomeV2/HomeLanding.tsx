...
.hv-feat{max-width:1240px;margin:0 auto;padding:clamp(2rem,4vw,3.4rem) clamp(1.15rem,4vw,3.2rem);display:grid;grid-template-columns:1.05fr .95fr;gap:clamp(2rem,5vw,4.5rem);align-items:end;}
